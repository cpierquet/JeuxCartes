...
\begin{codetex}[]
\textbf{\large Belote v1 \& Belote v2 :} \\ \\
\MainCartesJeuAleatoire[Hauteur=2.5,TypeJeu=Belote]{8} ou \MainCartesJeuAleatoire[Hauteur=2.5,TypeJeu=Belotev2]{8}.\\ \\
...
\AffCartesJeu[TypeJeu=Uno,Hauteur=1.85]{P4 § Coul}
